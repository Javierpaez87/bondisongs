  ...
  return (
    <footer className="bg-brand-text text-white/60 py-10 px-5">
      <div className="max-w-lg mx-auto">
        ...
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 text-white fill-white flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-white text-sm font-semibold leading-tight">
            ¿Tenés dudas? Contactate con nosotros y compongamos esa canción!
          </span>
        </a>
